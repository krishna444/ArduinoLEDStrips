...
protected:
    static constexpr float ADCres = 1023.0;
    const static int Beta = 3950;			// Beta parameter
    static constexpr float Kelvin = 273.15;	// 0°C = 273.15 K
    const static int Rb = 10000;			// 10 kOhm
    const static constexpr float Ginf = 120.6685;	// Ginf = 1/Rinf
...
protected:
    static constexpr float _gain = 1.414;
